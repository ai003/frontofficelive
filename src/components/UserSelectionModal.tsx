...
export default function UserSelectionModal({ onSelectUser }: UserSelectionModalProps) {
  return (
    <div className="fixed inset-0 bg-white dark:bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-400 dark:bg-gray-800 rounded-lg p-8 max-w-4xl w-full mx-4">
